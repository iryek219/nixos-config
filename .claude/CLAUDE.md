...
- Determinate Nix module enabled (required for OpenClaw)
- OpenClaw integration: nix-openclaw overlay, Telegram bot gateway
...
| `determinate` | DeterminateSystems/determinate | Determinate Nix (h-tuf, p-wsl) |
...
- nodejs_20: Excluded on h-tuf and p-wsl (OpenClaw provides its own Node.js)
