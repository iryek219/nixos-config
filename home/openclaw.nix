{
  ...
  sops.secrets."api-keys/gemini" = {};
  sops.secrets."api-keys/zai" = {};

  sops.templates."openclaw.env".content = ''
    ANTHROPIC_API_KEY=${config.sops.placeholder."api-keys/anthropic"}
    GEMINI_API_KEY=${config.sops.placeholder."api-keys/gemini"}
    ZAI_API_KEY=${config.sops.placeholder."api-keys/zai"}
  '';

  # Force-overwrite the module-generated config to avoid clobbering errors
  home.file.".openclaw/openclaw.json".force = true;

  # Create a custom config file to bypass the empty one generated by the module
  home.file.".openclaw/my-config.json" = {
    force = true;
